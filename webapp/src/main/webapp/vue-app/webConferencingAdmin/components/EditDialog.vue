    ...
    <v-card class="provider uiPopup">
      ...
      <v-card-text class="popupContent providerContent pa-4">
        <v-container class="permissions px-0">
          ...
          <v-row class="search">
            <v-col>
              <label class="searchLabel">{{ this.$t("webconferencing.admin.modal.SearchLabel") }}</label>
              <v-autocomplete
          ...
          <v-row>
            <v-col class="permissionsContainer">
              <div class="d-flex justify-space-between">
                <label class="searchLabel ma-0">{{ this.$t("webconferencing.admin.modal.WithPermissions") }}</label>
                <div class="d-flex align-center">
                  ...
                  <label style="color: #333">{{ this.$t("webconferencing.admin.modal.Everybody") }}</label>
                </div>
              </div>
              <v-row v-if="!accessibleToAll">
                ...
                <v-col 
                  ...
                  cols="12" 
                  md="8">
                  <label>{{ this.$t("webconferencing.admin.modal.None") }}</label>
                </v-col>
              </v-row>
            </v-col>
          </v-row>
      ...
      <v-card-actions class="dialogFooter footer justify-center pb-5">
        <v-btn 
          ...
          {{ this.$t("webconferencing.admin.buttons.Save") }}
        </v-btn>
        <v-btn 
